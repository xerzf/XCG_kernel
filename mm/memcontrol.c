...
static struct cgroup_subsys_state * __ref
mem_cgroup_css_async_alloc(struct cgroup_subsys_state *parent_css)
{
	struct mem_cgroup *parent = mem_cgroup_from_css(parent_css);
	struct mem_cgroup *memcg, *old_memcg;
...
static void mem_cgroup_css_async_alloc_fn(struct work_struct *work) { 
...
struct cgroup_subsys memory_cgrp_subsys = {
	...
	.css_async_alloc = mem_cgroup_css_async_alloc,
	.async_alloc_fn = mem_cgroup_css_async_alloc_fn,
